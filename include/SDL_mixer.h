...
typedef enum Mix_ADLMIDI_Emulator {
    ...
    /* Since libADLMIDI 1.6.2: Emulator of the OPL3 clone by Creative */
    ADLMIDI_OPL3_EMU_NUKED_CQM
    /* ------------------------------------------------------ */
...
/* Get the setup of maximum count of virtual chips (0 is unlimited, i.e. limited to 100) */
extern DECLSPEC int  MIXCALL Mix_OPNMIDI_getMaxChipsCount(void);/*MixerX*/
/* Set maximum count of virtual chips (integer between 1 and 100, or 0 to restore default setup) */
extern DECLSPEC void MIXCALL Mix_OPNMIDI_setMaxChipsCount(int chips);/*MixerX*/
/* Get the setup of the running at PCM rate (0 the chip runs at native rate, and 1 runs at PCM) */
extern DECLSPEC int  MIXCALL Mix_OPNMIDI_getRunAtPcmRate(void);/*MixerX*/
/* Let chip emulator run at PCM rate to reduce CPU load (1 enable, 0 disable) */
extern DECLSPEC void MIXCALL Mix_OPNMIDI_setRunAtPcmRate(int en);/*MixerX*/
/* Get the setup of low quality setup (1 enabled or 0 disabled) */
