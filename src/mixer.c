...
*/
void SDLCALLCC Mix_SetPostMix(void (*mix_func)
 ...
 */
void SDLCALLCC Mix_HookMusic(void (*mix_func)(void *udata, Uint8 *stream, int len),
                                                                void *arg)
{
    Mix_LockAudio();
    if ( mix_func != NULL ) {
...
void SDLCALLCC Mix_ChannelFinished(void (*channel_finished)(int channel))
{
    Mix_LockAudio();
